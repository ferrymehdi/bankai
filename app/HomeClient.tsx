      ...
      <div className="min-h-screen flex flex-col bg-white dark:bg-black text-gray-900 dark:text-gray-100">
        ...
        <main className="flex-grow flex flex-col justify-center items-center px-6 text-center space-y-6 py-10 max-w-7xl mx-auto w-full">
          ...
          <p className="max-w-xl text-muted-foreground text-lg leading-relaxed">
            Watch your favorite anime, manage your watch lists, and create
            playlists with a clean and easy-to-use interface.
          </p>
          <Button
          ...
          {/* Trending Now */}
          <h2 className="text-3xl font-semibold mt-16 mb-8 w-full text-left max-w-7xl">
            Trending Now
          </h2>
              ...
              : topAnime.map((anime, index) => (
                  <div
                    ...
                    className="
                      ...
                      shadow-lg focus:outline-none focus:ring-4 focus:ring-offset-2 focus:ring-primary-500
                      transition transform duration-300 ease-in-out
                      hover:scale-[1.05] hover:shadow-2xl hover:ring-4
                      hover:ring-primary-400 hover:animate-bounce-slow
                  ...
                  >
                    ...
                    <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/80 to-transparent p-4 rounded-b-xl">
                      ...
                      <p className="text-sm text-gray-300 truncate">
                        Score: {anime.score ?? "N/A"} | Episodes:{" "}
                        {anime.episodes ?? "N/A"}
                      </p>
                    </div>
                  </div>
